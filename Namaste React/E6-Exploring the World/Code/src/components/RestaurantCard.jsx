...
const RestaurantCard = (props) => {
  ...
  const{ resData } = props;
  const {cloudinaryImageId, name, cuisines, avgRatingString, costForTwo} = resData?.data; //here 1️⃣'const { cloudinaryImageId } = resData?.data;' is same as 2️⃣'const cloudinaryImageId = resData.data.cloudinaryImageId' but with optional chaining ?., basically 1️⃣ is 2️⃣ with optional chaining ?. //similarly for these as well ---> name, cuisines, avgRatingString, costForTwo
